...
export default {
  ...
  document_filtered: "Dokumentet godkändes ej",
  document_filtered_details: "Prova att skanna ett annat dokument.",
  ...
  help_modal_done_btn: "Klart",
  help_modal_next_btn: "Nästa",
  help_modal_title_1: "Håll alla fält synliga",
