...
export default {
  ...
  document_filtered: "Hati haikubaliki",
  document_filtered_details: "Jaribu kuskani hati tofauti.",
  ...
  help_modal_done_btn: "Umemaliza",
  help_modal_next_btn: "Endelea",
  help_modal_title_1: "Hakikisha sehemu zote zinaonekana",
