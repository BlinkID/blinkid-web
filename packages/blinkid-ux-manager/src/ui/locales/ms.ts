...
export default {
  ...
  document_filtered_details: "Cuba imbas dokumen yang berbeza.",
  ...
  help_modal_done_btn: "Siap",
  help_modal_next_btn: "Seterusnya",
  help_modal_title_1: "Pastikan semua medan kelihatan",
