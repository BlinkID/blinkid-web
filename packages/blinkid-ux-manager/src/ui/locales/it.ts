...
export default {
  alert_cancel_btn: "Annulla",
  alert_retry_btn: "Riprova",
  blur_detected: "Tieni immobili il documento e il telefono",
  camera_angle_too_steep: "Tieni il documento parallelo al telefono",
  document_filtered: "Documento non accettato",
  document_filtered_details: "Prova a scansionare un documento diverso.",
  document_not_recognized: "Documento non riconosciuto",
  ...
  help_modal_done_btn: "Fatto",
  help_modal_next_btn: "Avanti",
  help_modal_title_1: "Fai in modo tutti i campi siano visibili",
