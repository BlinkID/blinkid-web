...
export default {
  ...
  document_filtered: "No se acepta este documento",
  document_filtered_details: "Prueba a escanear otro documento.",
  ...
  help_modal_done_btn: "Finalizar",
  help_modal_next_btn: "Siguiente",
  help_modal_title_1: "Mantener visibles todos los campos",
