...
export default {
  ...
  document_filtered: "Dokument ni sprejet",
  document_filtered_details: "Poskusite optično prebrati drug dokument.",
  ...
  help_modal_done_btn: "Končano",
  help_modal_next_btn: "Naprej",
  help_modal_title_1: "Vidna morajo biti vsa polja",
